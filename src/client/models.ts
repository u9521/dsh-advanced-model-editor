...
function choice(value: string, label?: string) {
  return e('option', { key: value, value }, label === undefined ? value : label)
}
                      ...
                      [
                        ...
                        typeof candidate.maxTokens === 'number'
                          ? tr('models.discovery.maxTokens', {
                              value: core.formatCapacity(candidate.maxTokens),
                            })
                          : null,
                      ]
                        .filter(Boolean)
        ...
        e(
          ...
          e(
            ...
            e(CapacityInput, {
              ...
              placeholder: '256K',
              ariaLabelKey: 'models.field.contextWindow',
              onChange: (value) => update(index, 'contextWindow', value),
            }),
          ),
          e(
            'label',
            ...
            e(CapacityInput, {
              ...
              placeholder: '32K',
              ariaLabelKey: 'models.field.maxTokens',
              onChange: (value) => update(index, 'maxTokens', value),
            }),
          ),
        ),
      ),
