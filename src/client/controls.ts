...
import type { BackoffConfig, CompatProfile, RetryPolicyConfig } from './core.ts'
...
function option(
  ...
  return e('option', { key: String(value), value }, text(labelKey, labelVars))
}
...
export function CapacityInput(props: CapacityInputProps) {
  ...
  return e('input', {
    ...
    'aria-label': props.ariaLabelKey ? text(props.ariaLabelKey) : undefined,
