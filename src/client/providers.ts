...
import type { ModelApi, ProviderRow, SettingsNamespaceView } from './core.ts'
  ...
  const remove = async () => {
    ...
    try {
      if (typeof draft.apiKeyEnv === 'string' && draft.apiKeyEnv) {
        core.valueOf(await row.api.credentials.unset({ ref: draft.apiKeyEnv }))
      }
      core.valueOf(
        await row.api.settings.mutate({
          ns: core.SETTINGS_NS,
      ...
      e(
        ...
        field(
          ...
          e(Select, {
            ...
            choices: translatedChoices(core.THINKING_LEVELS, 'option.thinking'),
        ...
        field(
          ...
          e(Select, {
            ...
            choices: translatedChoices(core.CACHE_RETENTIONS, 'option.cache'),
            ...
            core.BUDGET_LEVELS.map((level) =>
              e(
                ...
                e(TextInput, {
                  ...
                  onChange: (value) => {
                    const next = {
                      ...(core.isObject(draft.thinkingBudgets)
      ...
      e(
        ...
        field(
          ...
          e(Select, {
            ...
            choices: translatedChoices(core.TRANSPORTS, 'option.transport'),
...
export function OfficialProviderEditor({
  ...
  const setField = (field: string, value: unknown) =>
    setDraft((current) => core.setIn(current, field, value))
  const ops = core.OFFICIAL_FIELDS.flatMap((field): core.SettingsPathOp[] => {
